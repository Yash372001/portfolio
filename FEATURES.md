# 🎨 Nikhil Pawar Portfolio - Complete Feature Overview
...
**Features:**
- Large animated title: "NIKHIL PAWAR"
...
### Color Palette
```css
--accent-1: #FF3366   /* Pink - Primary actions */
--accent-2: #6B4CE6   /* Purple - Secondary elements */
--accent-3: #FFD93D   /* Yellow - Highlights */
--accent-4: #00D9FF   /* Cyan - Accents */
